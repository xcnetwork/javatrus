...
document.write('<div id="rc-label"><div class="viewport"><ul>');
...
document.write('<li><a href="'+ link +'"><img src="'+ img +'"><div class="plus">'+ plus +'<div class="tHover">'+ title +'</div></div><h3>'+ title +'</h3></a></li>');
        }
